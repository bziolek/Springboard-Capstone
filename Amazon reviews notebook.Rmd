...
#Boxplot showing proportion of exclamation marks to total words by Score
ggplot(combined, aes(x = Score, y = Exclamation_summary_proportion, group = Score)) + 
 geom_boxplot()
 ggtitle("Proportion of exclamation marks to total words") +
 theme(plot.title = element_text(hjust = 0.5)) +
 labs(y= "Proportion as a percent", x = "Review Score")
